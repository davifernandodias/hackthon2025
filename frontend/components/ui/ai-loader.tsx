...
export const Component: React.FC<LoaderProps> = ({ size = 50, text = "" }) => {
  const letters = text.split("");

  return (
    <div className="  flex items-center justify-center bg-gradient-to-b  dark:from-gray-100 dark:via-gray-200 dark:to-gray-300">
      <div
